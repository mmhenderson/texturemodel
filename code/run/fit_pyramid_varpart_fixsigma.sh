...
# This is for running the low-versus-high variance partitioning
# on the models with fixed sigma values.
# Need to run fit_pyramid_fixsigma.sh first (to get pRF params)
...
do
    ...
    do
        ...
        prfs_model_name=texture_fixsigma$prf_fixed_sigma
        echo $prfs_model_name
